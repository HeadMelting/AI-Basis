...
def main():
    ...
    # Margin = 4
    parser.add_argument('--margin', type=int, default=4, metavar='M', help='the margin for the l-softmax formula (m=1, 2, 3, 4)')
    # Batch size = 256
    ...
    # learing rate = 0.1 
    parser.add_argument('--lr', type=float, default=0.1, metavar='LR', help='initial learning rate (default: 0.1)')
    # momentum = 0.9
    parser.add_argument('--momentum', type=float, default=0.9, metavar='M', help='SGD momentum (default: 0.9)')
    # weight decay = 0.0005 
    parser.add_argument('--weight-decay', type=float, default=5e-4, metavar='W', help='SGD weight decay (default: 0.0005)')
    # No_Cuda = false
    parser.add_argument('--no-cuda', action='store_true', default=False, help='disables CUDA training')
    # Seed = 1
    parser.add_argument('--seed', type=int, default=1, metavar='S', help='random seed (default: 1)')
    # log-interval = per 10 epoch
    parser.add_argument('--log-interval', type=int, default=10, metavar='N', help='how many batches to wait before logging training status')
    # visible 2d featrue = false
    parser.add_argument('--vis', type=bool,default=False, metavar='V', help='enables visualizing 2d features (default: False).')
